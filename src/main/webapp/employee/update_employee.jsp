    ...
    <body>
        <div class="container mt-5 mb-2 d-flex justify-content-center">
            <div class="card px-1 py-4" style="width: 300px;">
                <div class="card-body">
                    <h6 class="card-title mb-4">Update Employee</h6>

                    <form action="" method="POST" >
                        <div class="row">
                            <div class="col-sm-12 mb-2">
                                <div class="form-group">
                                    <input class="form-control inputlg" type="text" id="txtName" name="name" value="${requestScope.EMPLOYEE.name}"> 
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="row">
                            <div class="col-sm-12 mb-4">
                                <select class="form-control" id="txtDepartment" name="department">
                                    <c:forEach var="department" items="${requestScope.DEPARTMENTS}">
                                        <option value="${department.id}" 
                                                <c:if test="${department.id == requestScope.EMPLOYEE.department.id}">selected</c:if>>
                                            ${department.name}
                                        </option>
                                    </c:forEach>
                                </select> 
