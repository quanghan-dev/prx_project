    ...
    <body>
        <div class="container mt-5 mb-2 d-flex justify-content-center">
            <div class="card px-1 py-4" style="width: 300px;">
                <div class="card-body">
                    <h6 class="card-title mb-4">Create new Sprint</h6>
                    ...
                    <form action="" method="POST" >
                        ...
                        <div class="row">
                            <div class="col-sm-12 mb-4">
                                <select class="form-control" id="txtLanguage" name="duration">
        ...
        <h6 class="text-center">
            <a href="/Project/sprint?project_id=${param.project_id}">Back to Sprint</a>
        </h6>
    </body>
</html>
