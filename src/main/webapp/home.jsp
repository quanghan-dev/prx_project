...
<html>
    ...
    <body class="bg-white">
        ...
        <div class="mt-5 mb-3 mx-auto" style="width: 200px;">
            <a class="btn btn-primary" href="create-project" role="button">Create Company</a>
        </div>
            ...
            <tbody>
                <c:forEach var="project" items="${requestScope.COMPANY.projects}">
                    <tr class="row100 body">
                        ...
                        <td class="cell100 column3"><a href="sprint?project_id=${project.id}">Sprint</a></td>
